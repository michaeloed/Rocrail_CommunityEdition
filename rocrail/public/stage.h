...
#ifndef __object_Stage_H
#define __object_Stage_H
...
typedef struct OStage {
  ...
  /***** Object: Stage *****/
  /**  */
  struct OStage* (*inst)( iONode ini );
  /**  */
  void (*modify)( struct OStage* inst ,iONode modification );
  /**  */
  void (*setSectionOcc)( struct OStage* inst ,const char* sectionid ,const char* locoid );
} *iOStage;

extern struct OStage StageOp;
