...
static const char* _node_name(void) {
  return RocsWgen_system.name;
}
static const char* _node_remark(void) {
  return RocsWgen_system.remark;
}
static Boolean _node_required(void) {
  return RocsWgen_system.required;
}
static const char* _node_cardinality(void) {
  return RocsWgen_system.cardinality;
}
...
static Boolean _node_dump(iONode node) {
  if( node == NULL && RocsWgen_system.required ) {
    TraceOp.trc( "param", TRCLEVEL_EXCEPTION, __LINE__, 9999, ">>>>> Required node system not found!" );
    return False;
  }
  else if( node == NULL ) {
    TraceOp.trc( "param", TRCLEVEL_WRAPPER, __LINE__, 9999, "Node system not found!" );
    return True;
  }
...
struct __wSystemActions wSystemActions = {
  _node_name,
  _node_remark,
  _node_required,
  _node_cardinality,
