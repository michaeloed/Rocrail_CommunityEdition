...
#ifndef __object_CBUS_H
#define __object_CBUS_H
...
typedef struct OCBUS {
  ...
  /***** Object: CBUS *****/
  /**  */
  struct OCBUS* (*inst)( const iONode ini ,const iOTrace trc );
} *iOCBUS;

extern struct OCBUS CBUSOp;
