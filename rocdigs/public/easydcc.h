...
#ifndef __object_EasyDCC_H
#define __object_EasyDCC_H
...
typedef struct OEasyDCC {
  ...
  /***** Object: EasyDCC *****/
  /**  */
  struct OEasyDCC* (*inst)( const iONode ini ,const iOTrace trc );
} *iOEasyDCC;

extern struct OEasyDCC EasyDCCOp;
