...
#ifndef __object_Raptor_H
#define __object_Raptor_H
...
typedef struct ORaptor {
  ...
  /***** Object: Raptor *****/
  /**  */
  struct ORaptor* (*inst)( const iONode ini ,const iOTrace trc );
} *iORaptor;

extern struct ORaptor RaptorOp;
