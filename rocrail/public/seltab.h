...
#ifndef __object_SelTab_H
#define __object_SelTab_H
...
typedef struct OSelTab {
  ...
  /***** Object: SelTab *****/
  /**  */
  struct OSelTab* (*inst)( iONode ini );
  /**  */
  Boolean (*isLocked)( struct OSelTab* inst ,const char* locid );
  /** true if the fiddle yard is block manager */
  Boolean (*isManager)( struct OSelTab* inst );
  /** true if the sensor state matches the wanted state */
  Boolean (*isSet)( struct OSelTab* inst );
  /**  */
  void (*modify)( struct OSelTab* inst ,iONode mod );
} *iOSelTab;

extern struct OSelTab SelTabOp;
