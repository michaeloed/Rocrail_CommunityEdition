...
#ifndef __object_rocNet_H
#define __object_rocNet_H
...
typedef struct OrocNet {
  ...
  /***** Object: rocNet *****/
  /**  */
  struct OrocNet* (*inst)( const iONode ini ,const iOTrace trc );
} *iOrocNet;

extern struct OrocNet rocNetOp;
