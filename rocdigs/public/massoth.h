...
#ifndef __object_Massoth_H
#define __object_Massoth_H
...
typedef struct OMassoth {
  ...
  /***** Object: Massoth *****/
  /**  */
  struct OMassoth* (*inst)( const iONode ini ,const iOTrace trc );
} *iOMassoth;

extern struct OMassoth MassothOp;
