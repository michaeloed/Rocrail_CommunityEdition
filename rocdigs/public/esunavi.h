...
#ifndef __object_ESUNavi_H
#define __object_ESUNavi_H
...
typedef struct OESUNavi {
  ...
  /***** Object: ESUNavi *****/
  /**  */
  struct OESUNavi* (*inst)( const iONode ini ,const iOTrace trc );
} *iOESUNavi;

extern struct OESUNavi ESUNaviOp;
