...
#ifndef __object_BiDiB_H
#define __object_BiDiB_H
...
typedef Boolean(*sublib_write)(obj,byte*,byte,byte*,int,void*);
typedef Boolean(*sublib_available)(obj);



typedef struct OBiDiB {
  /***** Base *****/
  struct OBase  base;
  ...
  /***** Object: BiDiB *****/
  /**  */
  struct OBiDiB* (*inst)( const iONode ini ,const iOTrace trc );
} *iOBiDiB;

extern struct OBiDiB BiDiBOp;
