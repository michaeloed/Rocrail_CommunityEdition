...
#
echo "Creating packages for Windows is currently not supported as parts of the script seem outdated!"
return 1
...
# Substitute variables in the default freerail.iss file
...
cd ../freerail/package
pwd
sed s/\<BZR\>/$BAZAARREV/ < freerail-template.iss > freerail-temp2.iss
mv freerail-temp2.iss freerail-temp.iss
...
wine "c:\\Program Files\\Inno Setup 5\\ISCC.exe" freerail-temp.iss
rm freerail-temp.iss
