...
#ifndef __object_Virtual_H
#define __object_Virtual_H
...
typedef struct OVirtual {
  ...
  /***** Object: Virtual *****/
  /**  */
  struct OVirtual* (*inst)( const iONode ini ,const iOTrace trc );
} *iOVirtual;

extern struct OVirtual VirtualOp;
