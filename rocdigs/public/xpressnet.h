...
#ifndef __object_XpressNet_H
#define __object_XpressNet_H
...
typedef int(*sublib_read)(obj,byte*,Boolean*);
typedef Boolean(*sublib_write)(obj,byte*,Boolean*);
typedef void(*sublib_init)(obj);
typedef Boolean(*sublib_available)(obj);
typedef void(*sublib_translate)(obj, void*);



typedef struct OXpressNet {
  /***** Base *****/
  struct OBase  base;
  ...
  /***** Object: XpressNet *****/
  /**  */
  struct OXpressNet* (*inst)( const iONode ini ,const iOTrace trc );
} *iOXpressNet;

extern struct OXpressNet XpressNetOp;
