...
static const char* _node_name(void) {
  return RocsWgen_sensormonitor.name;
}
static const char* _node_remark(void) {
  return RocsWgen_sensormonitor.remark;
}
static Boolean _node_required(void) {
  return RocsWgen_sensormonitor.required;
}
static const char* _node_cardinality(void) {
  return RocsWgen_sensormonitor.cardinality;
}
...
static struct __attrdef RocsWgen_cx = {
  "cx",  "Width of SensorMonitor",  "",  "int",  "420",  "*",  False,
};
static int _getcx(iONode node) {
  ...
  xNode( RocsWgen_sensormonitor, node );
...
static struct __attrdef RocsWgen_cy = {
  "cy",  "Height of SensorMonitor",  "",  "int",  "120",  "*",  False,
};
...
static struct __attrdef RocsWgen_x = {
  "x",  "X position of SensorMonitor",  "",  "int",  "0",  "*",  False,
};
...
static struct __attrdef RocsWgen_y = {
  "y",  "Y position of SensorMonitor",  "",  "int",  "0",  "*",  False,
};
...
static Boolean _node_dump(iONode node) {
  if( node == NULL && RocsWgen_sensormonitor.required ) {
    TraceOp.trc( "param", TRCLEVEL_EXCEPTION, __LINE__, 9999, ">>>>> Required node sensormonitor not found!" );
    return False;
  }
  else if( node == NULL ) {
    TraceOp.trc( "param", TRCLEVEL_WRAPPER, __LINE__, 9999, "Node sensormonitor not found!" );
    return True;
  }
...
struct __wSensorMonitor wSensorMonitor = {
  _node_name,
  _node_remark,
  _node_required,
  _node_cardinality,
