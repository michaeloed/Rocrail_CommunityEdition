...
#ifndef __object_DMX4ALL_H
#define __object_DMX4ALL_H
...
typedef struct ODMX4ALL {
  ...
  /***** Object: DMX4ALL *****/
  /**  */
  struct ODMX4ALL* (*inst)( const iONode ini ,const iOTrace trc );
} *iODMX4ALL;

extern struct ODMX4ALL DMX4ALLOp;
