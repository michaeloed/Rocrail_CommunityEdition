...
#ifndef __object_Z21_H
#define __object_Z21_H
...
typedef enum {DECMODE_DEF=0, DECMODE_DCC, DECMODE_MM} decmode;
...
typedef struct OZ21 {
  ...
  /***** Object: Z21 *****/
  /**  */
  struct OZ21* (*inst)( const iONode ini ,const iOTrace trc );
} *iOZ21;

extern struct OZ21 Z21Op;
