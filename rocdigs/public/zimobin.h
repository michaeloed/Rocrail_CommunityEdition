...
#ifndef __object_ZimoBin_H
#define __object_ZimoBin_H
...
typedef struct OZimoBin {
  ...
  /***** Object: ZimoBin *****/
  /**  */
  struct OZimoBin* (*inst)( const iONode ini ,const iOTrace trc );
} *iOZimoBin;

extern struct OZimoBin ZimoBinOp;
