...
#ifndef __object_RocoMP_H
#define __object_RocoMP_H
...
typedef struct ORocoMP {
  ...
  /***** Object: RocoMP *****/
  /**  */
  struct ORocoMP* (*inst)( const iONode ini ,const iOTrace trc );
} *iORocoMP;

extern struct ORocoMP RocoMPOp;
