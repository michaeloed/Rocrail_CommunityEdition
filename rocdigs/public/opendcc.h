...
#ifndef __object_OpenDCC_H
#define __object_OpenDCC_H
...
typedef struct OOpenDCC {
  ...
  /***** Object: OpenDCC *****/
  /**  */
  struct OOpenDCC* (*inst)( const iONode ini ,const iOTrace trc );
} *iOOpenDCC;

extern struct OOpenDCC OpenDCCOp;
