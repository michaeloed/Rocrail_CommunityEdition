...
#ifndef __object_Barjut_H
#define __object_Barjut_H
...
typedef struct OBarjut {
  ...
  /***** Object: Barjut *****/
  /**  */
  struct OBarjut* (*inst)( const iONode ini ,const iOTrace trc );
} *iOBarjut;

extern struct OBarjut BarjutOp;
