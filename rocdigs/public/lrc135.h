...
#ifndef __object_LRc135_H
#define __object_LRc135_H
...
typedef struct OLRc135 {
  ...
  /***** Object: LRc135 *****/
  /**  */
  struct OLRc135* (*inst)( const iONode ini ,const iOTrace trc );
} *iOLRc135;

extern struct OLRc135 LRc135Op;
