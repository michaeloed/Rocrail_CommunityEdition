...
#ifndef __object_uConS88_H
#define __object_uConS88_H
...
typedef struct OuConS88 {
  ...
  /***** Object: uConS88 *****/
  /**  */
  struct OuConS88* (*inst)( const iONode ini ,const iOTrace trc );
} *iOuConS88;

extern struct OuConS88 uConS88Op;
