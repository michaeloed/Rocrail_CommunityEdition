...
#ifndef __object_RcLink_H
#define __object_RcLink_H
...
typedef struct ORcLink {
  ...
  /***** Object: RcLink *****/
  /**  */
  struct ORcLink* (*inst)( const iONode ini ,const iOTrace trc );
} *iORcLink;

extern struct ORcLink RcLinkOp;
