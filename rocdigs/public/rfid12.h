...
#ifndef __object_RFID12_H
#define __object_RFID12_H
...
typedef struct ORFID12 {
  ...
  /***** Object: RFID12 *****/
  /**  */
  struct ORFID12* (*inst)( const iONode ini ,const iOTrace trc );
} *iORFID12;

extern struct ORFID12 RFID12Op;
