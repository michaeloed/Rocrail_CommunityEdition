...
#ifndef __object_EditsPro_H
#define __object_EditsPro_H
...
typedef struct OEditsPro {
  ...
  /***** Object: EditsPro *****/
  /**  */
  struct OEditsPro* (*inst)( const iONode ini ,const iOTrace trc );
} *iOEditsPro;

extern struct OEditsPro EditsProOp;
