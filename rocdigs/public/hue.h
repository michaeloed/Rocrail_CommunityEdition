...
#ifndef __object_HUE_H
#define __object_HUE_H
...
typedef enum {HUE_GETBRIDGECONFIG=1, HUE_GETLIGHTSTATE, HUE_GETLIGHTS } huecmd;
...
typedef struct OHUE {
  ...
  /***** Object: HUE *****/
  /**  */
  struct OHUE* (*inst)( const iONode ini ,const iOTrace trc );
} *iOHUE;

extern struct OHUE HUEOp;
