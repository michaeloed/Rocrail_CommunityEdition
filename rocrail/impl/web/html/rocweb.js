...
function langDE() {
  ...
  document.getElementById("helpLink").href = "TBD";
...
function getString(s) {
  ...
  if( lang == "de" ) {
    ...
    if( s == "shutdownwarning" ) return "Der FreeRail Server wird hiermit beendet! Herunterfahren und beenden?";
    ...
    if( s == "shutdownwarning" ) return "This will shutdown the FreeRail server! Shutdown and exit?";
    ...
    if( s == "shutdownwarning" ) return "De FreeRail server wordt gestopt! Er kunnen nog locs rijden! FreeRail afsluiten?";
    ...
    if( s == "shutdownwarning" ) return "Cela arrêtera le serveur FreeRail ! Arrêter et quitter ?";
    ...
    try {
      ...
      if( xmlDoc != null ) {
        ...
        if( planlist.length > 0 ) {
          ...
          serverInfo.innerHTML = "N/A" + "<br>" + rocrailpwd;
