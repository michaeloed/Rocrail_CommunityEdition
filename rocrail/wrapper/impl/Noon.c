...
static const char* _node_name(void) {
  return RocsWgen_noon.name;
}
static const char* _node_remark(void) {
  return RocsWgen_noon.remark;
}
static Boolean _node_required(void) {
  return RocsWgen_noon.required;
}
static const char* _node_cardinality(void) {
  return RocsWgen_noon.cardinality;
}
...
static Boolean _node_dump(iONode node) {
  if( node == NULL && RocsWgen_noon.required ) {
    TraceOp.trc( "param", TRCLEVEL_EXCEPTION, __LINE__, 9999, ">>>>> Required node noon not found!" );
    return False;
  }
  else if( node == NULL ) {
    TraceOp.trc( "param", TRCLEVEL_WRAPPER, __LINE__, 9999, "Node noon not found!" );
    return True;
  }
