...
#ifndef __object_TamsMC_H
#define __object_TamsMC_H
...
typedef struct OTamsMC {
  ...
  /***** Object: TamsMC *****/
  /**  */
  struct OTamsMC* (*inst)( const iONode ini ,const iOTrace trc );
} *iOTamsMC;

extern struct OTamsMC TamsMCOp;
