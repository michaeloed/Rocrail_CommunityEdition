...
#ifndef __object_Inter10_H
#define __object_Inter10_H
...
typedef struct OInter10 {
  ...
  /***** Object: Inter10 *****/
  /**  */
  struct OInter10* (*inst)( const iONode ini ,const iOTrace trc );
} *iOInter10;

extern struct OInter10 Inter10Op;
