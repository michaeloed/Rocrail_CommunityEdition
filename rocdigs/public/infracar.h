...
#ifndef __object_Infracar_H
#define __object_Infracar_H
...
typedef struct OInfracar {
  ...
  /***** Object: Infracar *****/
  /**  */
  struct OInfracar* (*inst)( const iONode ini ,const iOTrace trc );
} *iOInfracar;

extern struct OInfracar InfracarOp;
