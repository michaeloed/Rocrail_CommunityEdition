...
#ifndef __object_P50_H
#define __object_P50_H
...
typedef enum {P50_OK=1, P50_ERROR, P50_CTSERR, P50_SNDERR, P50_RCVERR} p50state;
...
typedef struct OP50 {
  ...
  /***** Object: P50 *****/
  /**  */
  struct OP50* (*inst)( const iONode ini ,const iOTrace trc );
} *iOP50;

extern struct OP50 P50Op;
