...
#ifndef __object_HSI88_H
#define __object_HSI88_H
...
typedef enum {HSI88_OK=1, HSI88_ERROR, HSI88_CTSERR, HSI88_SNDERR, HSI88_RCVERR} HSI88state;



typedef struct OHSI88 {
  /***** Base *****/
  struct OBase  base;
  ...
  /***** Object: HSI88 *****/
  /**  */
  struct OHSI88* (*inst)( const iONode ini ,const iOTrace trc );
} *iOHSI88;

extern struct OHSI88 HSI88Op;
