...
#ifndef __object_DMXArtNet_H
#define __object_DMXArtNet_H
...
typedef struct ODMXArtNet {
  ...
  /***** Object: DMXArtNet *****/
  /**  */
  struct ODMXArtNet* (*inst)( const iONode ini ,const iOTrace trc );
} *iODMXArtNet;

extern struct ODMXArtNet DMXArtNetOp;
