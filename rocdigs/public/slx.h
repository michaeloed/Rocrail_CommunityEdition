...
#ifndef __object_SLX_H
#define __object_SLX_H
...
typedef enum {SLX_OK=1, SLX_ERROR, SLX_SNDERR, SLX_RCVERR} slxstate;
typedef enum {WRITE_FLAG=0x80, DATA_MASK=0x7F} __slxheader;
...
typedef struct OSLX {
  ...
  /***** Object: SLX *****/
  /**  */
  struct OSLX* (*inst)( const iONode ini ,const iOTrace trc );
} *iOSLX;

extern struct OSLX SLXOp;
