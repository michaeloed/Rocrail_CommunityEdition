...
#ifndef __object_DMXEUROLITE_H
#define __object_DMXEUROLITE_H
...
typedef struct ODMXEUROLITE {
  ...
  /***** Object: DMXEUROLITE *****/
  /**  */
  struct ODMXEUROLITE* (*inst)( const iONode ini ,const iOTrace trc );
} *iODMXEUROLITE;

extern struct ODMXEUROLITE DMXEUROLITEOp;
