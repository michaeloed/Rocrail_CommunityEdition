...
#ifndef __object_MttmFcc_H
#define __object_MttmFcc_H
...
typedef struct OMttmFcc {
  ...
  /***** Object: MttmFcc *****/
  /**  */
  struct OMttmFcc* (*inst)( const iONode ini ,const iOTrace trc );
} *iOMttmFcc;

extern struct OMttmFcc MttmFccOp;
