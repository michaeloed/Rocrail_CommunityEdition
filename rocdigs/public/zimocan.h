...
#ifndef __object_ZimoCAN_H
#define __object_ZimoCAN_H
...
typedef struct OZimoCAN {
  ...
  /***** Object: ZimoCAN *****/
  /**  */
  struct OZimoCAN* (*inst)( const iONode ini ,const iOTrace trc );
} *iOZimoCAN;

extern struct OZimoCAN ZimoCANOp;
